    ...
    return (
        <div data-aos="fade-in" data-aos-duration="1500" className='bg-white px-4 md:px-16 py-16' id="about">
            ...
            <div className='flex flex-col md:flex-row md:mt-24 justify-center items-center'>
                <div className=' md:w-1/2 pr-0 md:pr-4 md:ml-55 mt-20  sm:flex justify-center'>
                    <img data-aos="zoom-in-down" data-aos-duration="1500" className=' w-80 h-80 md:h-96 md:w-96 border-4 rounded-full object-cover' src={logo} alt="Quienes Somos" />
                </div>
