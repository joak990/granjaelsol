...
function About() {
    return (
        <div data-aos="fade-right" data-aos-duration="1500" className='bg-white px-4 md:px-16 py-16' id="about">
        ...
        <div className='flex flex-col md:flex-row md:mt-24 justify-center items-center'>
            ...
            <div data-aos="fade-left"  data-aos-duration="1500" className='w-full md:w-1/2 mt-6 md:mt-0  md:mr-44 text-xl md:text-3xl'>
