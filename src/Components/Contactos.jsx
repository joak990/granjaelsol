        ...
        <div className='bg-red-700 p-4 md:p-8' id="contactos">
            <div className='max-w-screen-md mx-auto'>
                ...
                <div   className="flex justify-center">
                    ...
                    <a data-aos="fade-in" data-aos-duration="1500"  href="https://api.whatsapp.com/send?phone=541131666991 " target="_blank" rel="noopener noreferrer"  className='mt-4 md:mt-16 text-white bg-red-900 hover:bg-red-500 w-full md:w-96 rounded-full items-center flex justify-center text-xl md:text-2xl mb-4 p-4'>
